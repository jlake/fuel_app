<?php echo Form::open(); ?>
	...
	<fieldset>
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('name', Input::post('name', isset($comment) ? $comment->name : ''), array('class' => 'span4')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('email', Input::post('email', isset($comment) ? $comment->email : ''), array('class' => 'span4')); ?>
		...
		<div class="clearfix">
			...
			<div class="input">
				<?php echo Form::input('website', Input::post('website', isset($comment) ? $comment->website : ''), array('class' => 'span4')); ?>
